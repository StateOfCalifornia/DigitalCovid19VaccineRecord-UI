  ...
  return (
    <div>
      <div className="DashContainer bodyContainer">
        <section>
          <h1 style={{ fontSize: '38px', fontWeight: '700', color: "#F06724", margin: '50px 0' }}>
      ...
      <section className='DashContainer' style={{ marginBottom: '64px', marginTop: '10px', fontSize: '18px' }}>
        <article>
          <span><Trans i18nKey="vaccineform.safe">Safe, free, and effective COVID-19 vaccines are now available to
            ...
            <ReactGA.OutboundLink
              ...
              target="_blank"
              style={{ display: 'inline', color: "#0D6EFD", margin: '0 5px', textDecoration: "underline" }}
            >
              get vaccinated.
            </ReactGA.OutboundLink>
          </Trans>
